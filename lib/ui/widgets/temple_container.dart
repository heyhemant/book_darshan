...
import 'package:book_darshan/ui/screens/details.dart';
...
class TempleContainer extends StatelessWidget {
  ...
  const TempleContainer({Key key, this.id}) : super(key: key);
  @override
                    ...
                    children: <Widget>[
                      Flexible(
                        child: SmoothStarRating(
                          rating: templeInfo[id].reviews,
                          size: 15,
                          color: MyColors.orange,
                        ),
                      ),
                      Text("(${templeInfo[id].reviewCount})"),
                    ],
                  )
                ],
              ),
